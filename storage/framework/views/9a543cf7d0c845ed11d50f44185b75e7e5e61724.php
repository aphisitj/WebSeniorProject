<?php $__env->startSection('content'); ?>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-clock-o"></i> Accident Case of week</span>
              <div class="count">132</div>
            </div>

            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-clock-o"></i> Accident Case</span>
              <div class="count">1567</div>
              
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> report accident case</span>
              <div class="count green">127</div>
                    ...
                    <tr>
                      ...
                      <td>
                        <table class="tile_info">
                          ...
                          <tr>
                            <td>
                              <p><i class="fa fa-square red"></i>1 </p>
                            </td>
                            <td>30%</td>
                          </tr>
                        </table>
