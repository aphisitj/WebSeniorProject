        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div class="count"><?php echo e($countacc); ?></div>
             
             
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"></i>Emergency Case</span>
              <div class="count"><?php echo e($countemerall); ?></div>
             
             
            </div>
             <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"></i>Emergency Case need help!!</span>
              <div class="count"><?php echo e($countemeruser); ?></div>
                      ...
                      <td>
                        <table class="tile_info">
                          <tr>
                            ...
                            <td><?php echo e($countrate105); ?>%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square green"></i>4 </p>
                            </td>
                            <td><?php echo e($countrate104); ?>%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square purple"></i>3 </p>
                            </td>
                            <td><?php echo e($countrate103); ?>%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square aero"></i>2 </p>
                            </td>
                            <td><?php echo e($countrate102); ?>%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square blue"></i>1 </p>
                            </td>
                            <td><?php echo e($countrate101); ?>%</td>
                          </tr>
                        </table>
                      </td>
                    </tr>
...
<!-- Flot -->
    ...
    <!-- jVectorMap -->
    <script src="<?php echo URL::asset('js/maps/jquery-jvectormap-world-mill-en.js'); ?>"></script>
    <script src="<?php echo URL::asset('js/maps/jquery-jvectormap-us-aea-en.js'); ?>"></script>
    <script src="<?php echo URL::asset('js/maps/gdp-data.js'); ?>"></script>
    <script>
      $(document).ready(function(){
      ...
      $(document).ready(function(){
        ...
        new Chart(document.getElementById("canvas1"), {
          ...
          data: {
            ...
            datasets: [{
              data: [<?php echo e($countrate1); ?>, <?php echo e($countrate2); ?>, <?php echo e($countrate3); ?>, <?php echo e($countrate4); ?>,<?php echo e($countrate5); ?>],
              backgroundColor: [
                "#3498DB",
                "#BDC3C7",
                "#9B59B6",                
